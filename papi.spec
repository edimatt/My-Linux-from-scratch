...
Source0: http://icl.utk.edu/projects/papi/downloads/%{system_name}-%{version}.tar.xz
BuildRequires: EDOncurses-devel
...
pathfix.py -n -i %_bindir/python3 $RPM_BUILD_ROOT%_bindir/*.py
...
%{_bindir}/*
%{_libdir}/*.so.*
%doc INSTALL.txt LICENSE.txt RELEASENOTES.txt
