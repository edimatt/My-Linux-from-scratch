...
BuildRequires:  EDOnettle-devel EDOzlib-devel giflib-devel libjpeg-turbo-devel gtk3-devel EDOgnutls-devel libXpm-devel libjpeg-turbo-devel EDOtexinfo rpm-build EDOncurses-devel EDOlibffi-devel EDOxz-devel EDOsqlite-devel EDOzstd-devel EDOjansson-devel EDOp11-kit-devel EDOharfbuzz-devel EDOcairo-devel EDOfontconfig-devel EDOfreetype-devel
Requires:       atk at-spi2-atk at-spi2-core bzip2-libs EDOcairo cairo-gobject dbus-libs EDOfontconfig EDOfreetype fribidi gdk-pixbuf2 giflib glib2 glibc EDOgmp EDOgnutls graphite2 gtk3 EDOharfbuzz jbigkit-libs json-glib libblkid libbrotli libcap libdatrie libepoxy EDOlibffi libgcc libgcrypt libgpg-error libicu libidn2 libjpeg-turbo libmount libpng libselinux libstdc++ libstemmer libtasn1 libthai libtiff libtracker-sparql libunistring libwayland-client libwayland-cursor libwayland-egl libwebp libX11 libX11-xcb libXau libxcb libXcomposite libXcursor libXdamage libXext libXfixes libXi libXinerama libxkbcommon libxml2 libXrandr libXrender EDOzstd lz4-libs EDOncurses-libs EDOnettle EDOp11-kit pango EDOpcre EDOpcre2 pixman EDOsqlite-libs systemd-libs EDOxz-libs EDOzlib EDOjansson
...
%configure --disable-silent-rules --with-native-compilation --with-sound=yes --with-json=yes
%make_build
